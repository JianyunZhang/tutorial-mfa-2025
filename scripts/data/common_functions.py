...
from .config import input_mid_data_processor, glucose_6_labeled_input_metabolite_dict, glucose_labeled_ratio_list, glucose_unlabeled_ratio_list
...
def target_metabolite_data_loader(
    ...
    raw_data_frame = pd.read_excel(xlsx_file_path, sheet_name=xlsx_sheet_name, index_col=index_col_name, nrows=row_num, usecols=col_range)
